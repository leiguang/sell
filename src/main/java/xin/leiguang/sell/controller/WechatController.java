...
public class WechatController {
    ...
    public String authorize(@RequestParam("returnUrl") String returnUrl) {
        // 1. 配置
        // 2. 调用方法
        String url = "http://vex4tt.natappfree.cc/sell/wechat/userInfo";
        ...
        String redirectUrl = wxMpService.oauth2buildAuthorizationUrl(url, WxConsts.OAuth2Scope.SNSAPI_USERINFO, encodedReturnUrl);
